      ...
      >
        ...
        {isEditing ? (
          <>
            ...
            <button
              onClick={saveHandler}
              className="bg-white rounded-lg border mr-2 px-2 py-1 transition duration-300 ease-in-out transform hover:scale-105 hover:bg-black hover:bg-opacity-80 hover:text-white"
            >
              Save
            </button>
          </>
        ...
        <button
          ...
          className="bg-white rounded-lg border px-2 py-1 transition duration-300 ease-in-out transform hover:scale-105 hover:bg-black hover:bg-opacity-80 hover:text-white"
        >
          Hapus
        </button>
      </li>
